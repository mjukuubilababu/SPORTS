export function autoscale(e, o, now) {
    const reasons = [];
    ...
    if (desired > o.replicas)
        return { service_id: e.service_id, decided_at: now, current_replicas: o.replicas, desired_replicas: desired, action: "SCALE_OUT", reason_codes: reasons.length ? reasons : ["RPS_FORECAST"], cooldown_seconds: 60 };
    ...
    if (low && o.replicas > e.min_replicas)
        return { service_id: e.service_id, decided_at: now, current_replicas: o.replicas, desired_replicas: o.replicas - 1, action: "SCALE_IN", reason_codes: ["SUSTAINED_LOW_UTILIZATION"], cooldown_seconds: 300 };
